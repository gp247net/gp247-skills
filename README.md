...
| --- | --- | --- |
| [gp247-plugin-create](./skills/gp247-plugin-create/SKILL.md) | Scaffold and build a brand-new GP247 v2 plugin (Core 2.0 / TailAdmin), update-safe. | 2026-07-30 |
| [gp247-plugin-v1-to-v2](./skills/gp247-plugin-v1-to-v2/SKILL.md) | Upgrade an existing GP247 plugin from Core 1.x to Core 2.0. | 2026-07-29 |
| [gp247-template-create](./skills/gp247-template-create/SKILL.md) | Scaffold and build a brand-new GP247 v2 storefront template (theme), update-safe. | 2026-07-30 |
